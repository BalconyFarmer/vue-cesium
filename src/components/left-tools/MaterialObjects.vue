<template>
  <div class="ops-section">
    ...
    <div class="ops-tiles">
      <div
        class="ops-tile addMaterialLightLine"
        title="发光线条"
        @mousedown="mouseDown('addMaterial')"
      ></div>
      <div
        class="ops-tile addGridMaterialProperty"
        title="网格材质"
        @mousedown="mouseDown('addGridMaterialProperty')"
      ></div>
      <div
        class="ops-tile addColor"
        title="纯色材质"
        @mousedown="mouseDown('addColor')"
      ></div>
      <div
        class="ops-tile addImgMaterial"
        title="图片材质"
        @mousedown="mouseDown('addImgMaterial')"
      ></div>
      <div
        class="ops-tile addCheckerboardMaterialProperty"
        title="棋盘材质"
        @mousedown="mouseDown('addCheckerboardMaterialProperty')"
      ></div>
      <div
        class="ops-tile addStripeMaterialProperty"
        title="条纹材质"
        @mousedown="mouseDown('addStripeMaterialProperty')"
      ></div>
    </div>
  </div>
</template>
