  ...
  <div class="ops-section">
    ...
    <div class="ops-tiles">
      <div
        class="ops-tile b"
        title="bilbord"
        @mousedown="mouseDown('bilbord')"
      ></div>
      <div
        class="ops-tile addIconBackground"
        title="bilbordBG"
        @mousedown="mouseDown('addIconBackground')"
      ></div>
      <div
        class="ops-tile ParticalSys"
        title="粒子"
        @mousedown="mouseDown('ParticalSys')"
      ></div>
      <div class="ops-tile p" title="点" @mousedown="mouseDown('点')"></div>
      <div class="ops-tile Box" title="Box" @mousedown="mouseDown('Box')"></div>
      <div
        class="ops-tile addEllipse"
        title="椭圆"
        @mousedown="mouseDown('addEllipse')"
      ></div>
      <div
        class="ops-tile addEllipseTuo"
        title="椭圆体"
        @mousedown="mouseDown('addEllipseTuo')"
      ></div>
      <div
        class="ops-tile addEllipseTuoWW"
        title="椭圆体外轮廓"
        @mousedown="mouseDown('addEllipseTuoWW')"
      ></div>
      <div
        class="ops-tile y"
        title="圆柱体"
        @mousedown="mouseDown('圆柱体')"
      ></div>
      <div
        class="ops-tile glowingLine"
        title="发光线"
        @mousedown="mouseDown('glowingLine')"
      ></div>
      <div
        class="ops-tile orangeOutlined"
        title="橙色轮廓"
        @mousedown="mouseDown('orangeOutlined')"
      ></div>
      <div
        class="ops-tile yellowLine"
        title="黄线"
        @mousedown="mouseDown('yellowLine')"
      ></div>
      <div
        class="ops-tile redRectangle"
        title="红矩形"
        @mousedown="mouseDown('redRectangle')"
      ></div>
      <div
        class="ops-tile greenRectangle"
        title="绿矩形"
        @mousedown="mouseDown('greenRectangle')"
      ></div>
      <div
        class="ops-tile blueEllipsoid"
        title="蓝椭球"
        @mousedown="mouseDown('blueEllipsoid')"
      ></div>
      <div
        class="ops-tile redSphere"
        title="红球"
        @mousedown="mouseDown('redSphere')"
      ></div>
      <div
        class="ops-tile outlineOnly"
        title="仅轮廓"
        @mousedown="mouseDown('outlineOnly')"
      ></div>
      <div
        class="ops-tile redWall"
        title="红墙"
        @mousedown="mouseDown('redWall')"
      ></div>
      <div
        class="ops-tile greenWall"
        title="绿墙"
        @mousedown="mouseDown('greenWall')"
      ></div>
      <div
        class="ops-tile blueWall"
        title="蓝墙"
        @mousedown="mouseDown('blueWall')"
      ></div>
      <div
        class="ops-tile redCorridor"
        title="红走廊"
        @mousedown="mouseDown('redCorridor')"
      ></div>
      <div
        class="ops-tile redPolygon"
        title="红多边形"
        @mousedown="mouseDown('redPolygon')"
      ></div>
      <div
        class="ops-tile greenPolygon"
        title="绿多边形"
        @mousedown="mouseDown('greenPolygon')"
      ></div>
      <div
        class="ops-tile orangePolygon"
        title="橙多边形"
        @mousedown="mouseDown('orangePolygon')"
      ></div>
      <div
        class="ops-tile bluePolygon"
        title="蓝多边形"
        @mousedown="mouseDown('bluePolygon')"
      ></div>
      <div
        class="ops-tile redLine"
        title="红线"
        @mousedown="mouseDown('redLine')"
      ></div>
    </div>
  </div>
</template>
      ...
      if (this.addGeoFlag) {
        switch (this.currentGeoType) {
          case "addIconBackground":
            window.cApp.innerGeometry.addIconBackground(
              this.geoPositionCartesian2,
              "默认",
              2,
            );
            break;
          ...
          case "bilbord":
            ...
            window.cApp.innerGeometry.addIcon(
              this.geoPositionCartesian2,
              "默认",
            );
            break;
          ...
          case "addEllipseTuoWW":
            window.cApp.innerGeometry.addEllipseTuoWW(
              this.geoPositionCartesian2,
            );
            break;
          case "redCorridor":
          ...
          case "glowingLine":
            ...
            break;
          case "orangeOutlined":
            window.cApp.innerGeometry.orangeOutlined(
              this.geoPositionCartesian2,
            );
            break;
          case "yellowLine":
          ...
          case "redRectangle":
            ...
            break;
          case "greenRectangle":
            window.cApp.innerGeometry.greenRectangle(
              this.geoPositionCartesian2,
            );
            break;
          case "blueEllipsoid":
          ...
          case "addColor":
            ...
            break;
          case "addImgMaterial":
            window.cApp.innerMaterial.addImgMaterial(
              this.geoPositionCartesian2,
            );
            break;
          case "addCheckerboardMaterialProperty":
            window.cApp.innerMaterial.addCheckerboardMaterialProperty(
              this.geoPositionCartesian2,
            );
            break;
          case "addStripeMaterialProperty":
            window.cApp.innerMaterial.addStripeMaterialProperty(
              this.geoPositionCartesian2,
            );
            break;
          case "addGridMaterialProperty":
            window.cApp.innerMaterial.addGridMaterialProperty(
              this.geoPositionCartesian2,
            );
            break;
        }
